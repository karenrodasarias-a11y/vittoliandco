...
const BunnyMark = ({ size = 80, color = "#2B3A4A", strokeWidth = 1.6, src }) => (
  src
    ? <img src={src} alt="" style={{ width: size, height: size * 1.18, objectFit: "contain", display: "block" }} />
...
// Conejito oficial de Vittoli & Co. (imagen embebida). Vacía bunnyImage en el admin para volver al de línea.
const VITTOLI_BUNNY = "data:image/png;base64,";
...
const INIT_CONFIG = {
  ...
  bunnyImage: VITTOLI_BUNNY,          // imagen propia para el conejito (símbolo de marca); vacío = conejito de línea
  faviconImage: "",
        ...
        {config.heroImage
          ...
          : <div style={{ width: "100%", height: "100%", background: "linear-gradient(160deg, #F5EEEC, #F5F2EE, #EDF0EC)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <div style={{ textAlign: "center" }}>
                <BunnyMark size={92} color={C.noche} src={config.bunnyImage} />
        ...
        {tab === "images" && (
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
              ...
              <SingleImageUploader image={form.bunnyImage || ""} onChange={img => setForm(f => ({ ...f, bunnyImage: img }))} label="🐰 Conejito de marca" placeholder="PNG con fondo transparente · vacío = conejito de línea" />
...
export default function App() {
  ...
  if (!loaded) return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: C.white }}>
      <div style={{ textAlign: "center" }}>
        <motion.div animate={{ opacity: [0.45, 1, 0.45] }} transition={{ duration: 1.8, repeat: Infinity, ease: "easeInOut" }} style={{ marginBottom: 16, display: "flex", justifyContent: "center" }}><BunnyMark size={54} color={C.noche} src={VITTOLI_BUNNY} /></motion.div>
